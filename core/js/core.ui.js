      ...
      $(selector).each(function(i, elem) {
        ...
        frames.each(function(i, elem) {
          ...
          if (options.lightbox || options.clickBehavior == 'lightbox') {
            ...
            } else if (options.clickBehavior === 'lightbox') {
              link.attr('href', self.data('img-src'));
            } else {
          ...
          switch (options.clickBehavior) {
            case 'permalink':
              var permalink = self.data('permalink') || self.find('> a').attr('href');
              if (permalink) overlay.wrap('<a class="overlay-link" href="'+ permalink +'"></a>');
              break;
            case 'lightbox':
