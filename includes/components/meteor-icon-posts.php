<?php
  ...
  function meteor_image_icon_posts($atts, $content='', $code='') { global $der_framework;
    ...
    $show_excerpt = ($args['show_excerpt'] && $args['show_as_excerpt'] == 'excerpt');
    $show_content = ($args['show_excerpt'] && $args['show_as_excerpt'] == 'content');
  ...
  function meteor_vector_icon_posts($atts, $content='', $code='') { global $der_framework;
    ...
    $defaults = array(
      ...
      'show_excerpt' => true,
      'excerpt_align' => false,
      'show_as_excerpt' => 'excerpt', // (excerpt|content)
      'show_link' => true,
      'title_link' => false,
      'icon_link' => false,
      'link_align' => false,
